...
--      or 
-- Select * from zeptoDB.dbo.Users; (Use this when working on large projects) 
...
Select * from zeptoDB.dbo.Vendors; 
...
Select * from zeptoDB.dbo.ProductCategories; 
...
Select * from zeptoDB.dbo.Products;
...
Select * from zeptoDB.dbo.Inventory;
...
Select * from zeptoDB.dbo.Addresses;


-- Orders
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (2, 2, 110.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (3, 3, 120.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (4, 4, 130.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (5, 5, 140.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (6, 1, 150.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (7, 2, 160.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (8, 3, 170.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (9, 4, 180.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (10, 5, 190.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (1, 1, 200.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (2, 2, 210.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (3, 3, 220.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (4, 4, 230.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (5, 5, 240.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (6, 1, 250.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (7, 2, 260.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (8, 3, 270.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (9, 4, 280.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (10, 5, 290.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (1, 1, 100.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (2, 2, 110.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (3, 3, 120.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (4, 4, 130.00, GETDATE());
INSERT INTO Orders (UserID, VendorID, TotalAmount, OrderDate) VALUES (5, 5, 140.00, GETDATE());
...
Select * from zeptoDB.dbo.Orders;
...
Select * from zeptoDB.dbo.OrderItems;
...
Select * from zeptoDB.dbo.Payments;
...
Select * from zeptoDB.dbo.DeliveryStatus;
